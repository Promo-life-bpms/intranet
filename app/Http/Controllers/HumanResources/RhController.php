...
class RhController extends Controller
{
    ...
    public function noCompeteAgreement($name, $lastname, $company_id, $date_admission)
    {
        ...
        $section->addText(
            'a.	ES UNA SOCIEDAD CONSTITUIDA DE CONFORMIDAD CON LAS LEYES DE LOS ESTADOS UNIDOS MEXICANOS, SEGÚN CONSTA EN LA ESCRITURA NÚMERO 1881, DE FECHA 25 DE NOVIEMBRE DE 2014, OTORGADA ANTE EL LICENCIADO CLAUDIA GABRIELA FRANCÓZ GÁRATE, TITULAR DE LA NOTARÍA NÚMERO 153 DEL ESTADO DE MÉXICO. ',
            $titleStyle,
        );

        $section->addText(
            'b.	SU REPRESENTANTE CUENTA CON LAS FACULTADES SUFICIENTES PARA OBLIGAR A SU REPRESENTADA EN LOS TÉRMINOS DE ESTE CONVENIO, SEGÚN CONSTA EN LA ESCRITURA NÚMERO 1881, DE FECHA 28 DE NOVIEMBRE DE 2014, OTORGADA ANTE EL LICENCIADO CLAUDIA GABRIELA FRANCÓZ GÁRATE, TITULAR DE LA NOTARÍA NÚMERO 153 DEL ESTADO DE MÉXICO, MISMAS QUE A LA FECHA NO LE HAN SIDO REVOCADAS, LIMITADAS O MODIFICADAS DE FORMA ALGUNA.',
            $titleStyle,
        );

        $section->addText(
            'c.	ES SU DESEO CELEBRAR EL PRESENTE CONVENIO, SUJETO A LOS TÉRMINOS Y CONDICIONES QUE MÁS ADELANTE SE INDICAN.',
            $titleStyle,
        );
        ...
        $section->addText(
            'a.	ES UNA PERSONA FÍSICA CON PLENA CAPACIDAD JURÍDICA Y PLENO USO DE SUS FACULTADES LEGALES PARA SUSCRIBIR EL PRESENTE CONVENIO',
            $titleStyle,
        );

        $section->addText(
            'b.	CUENTA CON REGISTRO FEDERAL DE CONTRIBUYENTES RFC COMPLETO SEGÚN CONSTA EN LA CEDULA DE IDENTIFICACIÓN FISCAL, EXPEDIDA POR LA SECRETARIA DE HACIENDA Y CRÉDITO PÚBLICO.',
            $titleStyle,
        );

        $section->addText(
            'c.	DERIVADO DE SU RELACIÓN COMERCIAL Y/O PROFESIONAL Y/O PERSONAL CON BH TRADE MARKET, CON SUS ACCIONISTAS Y/O CON SUS DIRECTORES, QUE HA TENIDO DESDE HACE VARIOS AÑOS.  HA TENIDO Y SEGUIRÁ TENIENDO ACCESO A INFORMACIÓN CONFIDENCIAL DE BH TRADE MARKET Y/O DE SUS CLIENTES, ASÍ COMO A INFORMACIÓN CONFIDENCIAL DE GIRO COMERCIAL Y “KNOW HOW” DEL NEGOCIO DE BH TRADE MARKET, RECONOCIENDO QUE DICHA INFORMACIÓN CONFIDENCIAL REPRESENTA UN ACTIVO Y VENTAJA COMPETITIVA DE BH TRADE MARKET EN EL MERCADO, Y FRENTE A SUS COMPETIDORES..',
            $titleStyle,
        );

        $section->addText(
            'd.	RECONOCE QUE LA REVELACIÓN O USO INDEBIDO DE LA INFORMACIÓN CONFIDENCIAL DE BH TRADE MARKET, ASÍ COMO A INFORMACIÓN CONFIDENCIAL DE GIRO COMERCIAL Y “KNOW HOW” DEL NEGOCIO DE BH TRADE MARKET, CAUSARÍA A ESTA UN DAÑO SERIO E IRREPARABLE, ASÍ COMO AL DESARROLLO DE SUS OPERACIONES Y ACTIVIDADES COMERCIALES.',
            $titleStyle,
        );

        $section->addText(
            'e.	CUENTA CON LA CAPACIDAD Y RECURSOS SUFICIENTES PARA CELEBRAR Y EJECUTAR LAS OBLIGACIONES QUE ASUME CONFORME AL PRESENTE CONVENIO.',
            $titleStyle,
        );

        $section->addText(
            'f.	QUE LAS OBLIGACIONES CONTRAÍDAS POR EL EMPLEADO EN VIRTUD DE ESTE CONVENIO SON VÁLIDAS, LEGALMENTE VINCULANTES Y EXIGIBLES EN SU CONTRA, DE ACUERDO CON LOS TÉRMINOS INDICADOS EN EL MISMO.',
            $titleStyle,
        );
