...
class RhController extends Controller
{
    ...
    public function noCompeteAgreement($postulant, $postulant_details, $company_id, $duration)
    {
        ...
        $listItemRun = $section->addListItemRun(1, $multilevelListStyleName,[]);
        $listItemRun->addText('RECONOCE QUE LA REVELACIÓN O USO INDEBIDO DE LA INFORMACIÓN CONFIDENCIAL DE BH TRADE MARKET, ASÍ COMO A INFORMACIÓN CONFIDENCIAL DE GIRO COMERCIAL Y “KNOW HOW” DEL NEGOCIO DE BH TRADE MARKET, CAUSARÍA A ESTA UN DAÑO SERIO E IRREPARABLE, ASÍ COMO AL DESARROLLO DE SUS OPERACIONES Y ACTIVIDADES COMERCIALES.',$bodyNormalStyle);
        $listItemRun = $section->addListItemRun(1, $multilevelListStyleName,[]);
        ...
        $section2 = "<p>ASIMISMO, <b>EL EMPLEADO</b> SE OBLIGA A GUARDAR ESTRICTA CONFIDENCIALIDAD SOBRE TODA LA INFORMACIÓN CONFIDENCIAL (SEGÚN DICHO TÉRMINO SE DEFINE MÁS ADELANTE) A LA QUE TUVO ACCESO CON ANTERIORIDAD A ESTE ACTO, A LA QUE PUDIERA TENER ACCESO Y/O QUE LE SEA SUMINISTRADA O PROPORCIONADA, YA SEA DE FORMA VERBAL, ESCRITA O POR CUALQUIER OTRO MEDIO, POR BH TRADE MARKET, SUS EMPLEADOS, FUNCIONARIOS, ACCIONISTAS, REPRESENTANTES, AGENTES, CONSULTORES Y/O APODERADOS O CUALQUIER OTRA PERSONA RELACIONADA CON BH TRADE MARKET.</p>";
        $htmlsection->addHtml($section, $section2);

        $section2 = "<p><b>SEGUNDA.- NO COMPETENCIA (NON COMPETE). EL EMPLEADO</b> SE OBLIGA A NO PARTICIPAR, DIRECTA O INDIRECTAMENTE O A TRAVÉS DE TERCEROS, COMO EMPRESARIO, EMPLEADO, FUNCIONARIO, GERENTE, GERENTE DE VENTAS, AYUDANTE GENERAL, SOCIO, DIRECTOR, AGENTE, PROPIETARIO, ACCIONISTA O EN CUALQUIER OTRA CAPACIDAD, EN ALGUNA ACTIVIDAD QUE TENGA IDENTIDAD O SE RELACIONE CON EL GIRO COMERCIAL DE BH TRADE MARKET O DE CUALQUIERA DE SUS SUBSIDIARIAS Y/O CUALQUIER PERSONA FÍSICA O MORAL QUE APAREZCA EN LA LISTA DE CLIENTES (SEGÚN DICHO TÉRMINO SE DEFINE MÁS ADELANTE), INCLUYENDO CUALQUIER SOCIEDAD CUYO OBJETO SOCIAL SEA LA VENTA, COMPRA, IMPRESIÓN, FABRICACIÓN, COMERCIALIZACIÓN, IMPORTACIÓN, EXPORTACIÓN Y/O DISTRIBUCIÓN DE PRODUCTOS Y/O ARTÍCULOS PROMOCIONALES Y DE PUBLICIDAD, PRODUCTOS MÉDICOS, DE SALUD, TECNOLÓGICOS Y/O CUALQUIER OTRO PRODUCTO QUE PUEDA SER SUMINISTRADO POR BH TRADE MARKET ASÍ COMO EL DESARROLLO DE PROYECTOS DE COMERCIALIZACIÓN Y PUBLICIDAD DE PRODUCTOS EN MÉXICO Y/O EN EL EXTRANJERO.</p>";
        $htmlsection->addHtml($section, $section2);
        
        $section2 = "<p>A SU VEZ, <b>EL EMPLEADO</b> SE OBLIGA A ABSTENERSE DE INCURRIR EN CUALQUIER NEGOCIACIÓN, PLÁTICAS, ACERCAMIENTOS, OFERTAS, ASÍ COMO INDUCIR, SOLICITAR, CONTRATAR, INTERFERIR EN LA RELACIÓN COMERCIAL, DE FORMA DIRECTA O INDIRECTA CON CUALQUIERA DE LOS CLIENTES, PROVEEDORES, PROSPECTOS, EMPLEADOS, CONTRATISTAS Y/O VENDEDORES O CUALQUIER PERSONA FÍSICA O MORAL QUE APAREZCA EN LA LISTA DE CLIENTES DE BH TRADE MARKET O CUALQUIERA DE SUS SUBSIDIARIAS RESPECTO DE LOS SERVICIOS Y/O PRODUCTOS QUE BH TRADE MARKET, PRESTA, OFRECE Y/O VENDE AL PÚBLICO GENERAL (CONJUNTAMENTE CON LO ESTABLECIDO EN EL PÁRRAFO INMEDIATO ANTERIOR, LA “<b>NO COMPETENCIA</b>”).</p>";
        $htmlsection->addHtml($section, $section2);
        ...
        $section2 = "<p>LAS PARTES ACUERDAN QUE LA OBLIGACIÓN DE CONFIDENCIALIDAD ESTABLECIDA EN LA PRESENTE CLÁUSULA SERÁ APLICABLE A TODA LA INFORMACIÓN CONFIDENCIAL QUE BH TRADE MARKET LE HAYA TRANSMITIDO EL EMPLEADO POR CUALQUIER MEDIO PREVIO A LA CELEBRACIÓN DEL PRESENTE CONVENIO Y A CUALQUIER INFORMACIÓN CONFIDENCIAL A LA QUE HAYA TENIDO ACCESO O TENGA ACCESO COMO CONSECUENCIA DE CUALQUIER ACTO O HECHO DERIVADO DE SU RELACIÓN COMERCIAL Y/O PROFESIONAL Y/O PERSONAL Y/O CONTRACTUAL CON BH TRADE MARKET DERIVADO DE RELACIÓN COMERCIAL Y/O PROFESIONAL Y/O PERSONAL Y/O CONTRACTUAL CON BH TRADE MARKET O SUS SUBSIDIARIA</p>";
        $htmlsection->addHtml($section, $section2);
        ...
        $listItemRun = $section->addListItemRun(3, $multilevelListStyleName,[]);
        $listItemRun->addText('QUE BH TRADE MARKET AUTORICE EL EMPLEADO, PREVIA NOTIFICACIÓN Y POR ESCRITO, PARA SU DIVULGACIÓN O ENTREGA DE INFORMACIÓN CONFIDENCIAL A UN TERCERO; Y ',$bodyNormalStyle);
        
        $listItemRun = $section->addListItemRun(3, $multilevelListStyleName,[]);
        $listItemRun->addText('QUE EL EMPLEADO SEA INSTRUIDO MEDIANTE REQUERIMIENTO JUDICIAL DE ENTREGAR PARCIAL O TOTALMENTE LA INFORMACIÓN CONFIDENCIAL, EN CUYO CASO EL EMPLEADO, PREVIO A CUALQUIER ENTREGA DE LA INFORMACIÓN CONFIDENCIAL, SE OBLIGA A INFORMAR INMEDIATAMENTE A BH TRADE MARKET RESPECTO DE DICHO REQUERIMIENTO Y DEBERÁ REALIZAR LOS ACTOS QUE ESTÉN A SU ALCANCE PARA PREVENIR LA ENTREGA DE LA INFORMACIÓN CONFIDENCIAL PREVIO A INFORMAR A BH TRADE MARKET.',$bodyNormalStyle);
        ...
        $listItemRun = $section->addListItemRun(4, $multilevelListStyleName,[]);
        $listItemRun->addText('RESPONDER POR CUALQUIER VIOLACIÓN A LA OBLIGACIÓN DE NO COMPETENCIA Y/O CONFIDENCIALIDAD AQUÍ ESTABLECIDA, ASÍ COMO A LOS DERECHOS DE PROPIEDAD INTELECTUAL DE BH TRADE MARKET EN ESTE ACTO, EL EMPLEADO SE OBLIGA A RESPONDER DIRECTAMENTE ANTE BH TRADE MARKET POR CUALQUIER VIOLACIÓN A LA NO COMPETENCIA Y/O CONFIDENCIALIDAD QUE SEA COMETIDA POR EL EMPLEADO O EN GENERAL POR CUALQUIER OTRA PERSONA VINCULADA A EL EMPLEADO; Y ;',$bodyNormalStyle);

        $listItemRun = $section->addListItemRun(4, $multilevelListStyleName,[]);
        $listItemRun->addText('DEVOLVER INMEDIATAMENTE A BH TRADE MARKET TODA LA INFORMACIÓN CONFIDENCIAL, INCLUYENDO LOS DATOS PERSONALES, EN CASO DE QUE ASÍ LO SOLICITE BH TRADE MARKET Y/O CUANDO EL PRESENTE CONVENIO SEA TERMINADO O RESCINDIDO POR CUALQUIER MOTIVO. UNA VEZ TERMINADO EL PRESENTE CONVENIO, EL EMPLEADO NO PODRÁ, POR NINGÚN MOTIVO, MANTENER EN SU POSESIÓN INFORMACIÓN CONFIDENCIAL.',$bodyNormalStyle);

        $section2 = "<p><b>OCTAVA. - INCUMPLIMIENTO POR PARTE DE EL EMPLEADO</b>. EN CASO DE QUE <b>EL EMPLEADO</b>, O CUALESQUIER PERSONAS VINCULADAS DE CUALQUIER FORMA CON EL MISMO, INCUMPLA CON ALGUNA DE LAS OBLIGACIONES DERIVADAS DE ESTE CONVENIO, ASÍ COMO LAS OBLIGACIONES RESPECTO A LA NO COMPETENCIA, A LA INFORMACIÓN CONFIDENCIAL Y/O LAS OBLIGACIONES ESTABLECIDAS EN LA CLÁUSULA SÉPTIMA DEL PRESENTE CONVENIO, <b>EL EMPLEADO</b> ESTARÁ SUJETA A LA PENA CONVENCIONAL (SEGÚN DICHO TÉRMINO SE DEFINE MÁS ADELANTE) ESTABLECIDA EN LA CLÁUSULA NOVENA DEL PRESENTE CONVENIO; SIN PERJUICIO DE QUE DEBERÁ RESPONDER A LOS DAÑOS Y PERJUICIOS OCASIONADOS A BH TRADE MARKET, SUS EMPLEADOS, FUNCIONARIOS, ACCIONISTAS, O CUALQUIER OTRA PERSONA RELACIONADA CON BH TRADE MARKET. </p>";
        $htmlsection->addHtml($section, $section2);

        $section2 = "<p>LO ANTERIOR SIN PERJUICIO DEL DERECHO DE BH TRADE MARKET DE EJERCITAR LAS DEMÁS ACCIONES LEGALES, SANCIONES Y MULTAS QUE PROCEDAN POR LA VIOLACIÓN A LOS DERECHOS DE PROPIEDAD INTELECTUAL DE BH TRADE MARKET, INCLUIDAS, DE MANERA ENUNCIATIVA MAS NO LIMITATIVA, EN LA LEY DE LA PROPIEDAD INDUSTRIAL Y EN EL CÓDIGO PENAL FEDERAL O CUALESQUIER LEYES QUE EN UN FUTURA LAS SUSTITUYAN Y/O SEA APLICABLE.</p>";
        $htmlsection->addHtml($section, $section2);

        $section2 = "<p><b>EL EMPLEADO</b> EN ESTE ACTO SE OBLIGA A SACAR EN PAZ Y A SALVO A BH TRADE MARKET, SUS EMPLEADOS, FUNCIONARIOS, ACCIONISTAS, O CUALQUIER OTRA PERSONA RELACIONADA CON BH TRADE MARKET DE CUALQUIER RECLAMACIÓN, DEMANDA, DENUNCIA, PROCEDIMIENTO JUDICIAL O EXTRAJUDICIAL O INVESTIGACIÓN DE CUALQUIER NATURALEZA, QUE SEAN CONSECUENCIA DEL INCUMPLIMIENTO DE LAS OBLIGACIONES DE NO COMPETENCIA Y/O CONFIDENCIALIDAD PREVISTAS EN EL PRESENTE CONVENIO POR PARTE DE <b>EL EMPLEADO</b>, O CUALESQUIER PERSONAS VINCULADAS DE CUALQUIER FORMA CON EL MISMO.</p>";
        $htmlsection->addHtml($section, $section2);
        ...
        $section2 = "<p><b>NOVENA. - PENA CONVENCIONAL.  EL EMPLEADO</b> ACEPTA Y SE OBLIGA EXPRESAMENTE A QUE EN CASO DE INCURRIR EN INCUMPLIMIENTO DE CUALQUIERA DE SUS OBLIGACIONES DERIVADAS DEL PRESENTE CONVENIO, INCLUYENDO DE MANERA ENUNCIATIVA MÁS NO LIMITATIVA, LAS OBLIGACIONES DE NO COMPETENCIA, DE CONFIDENCIALIDAD Y/O LAS OBLIGACIONES ESTABLECIDAS EN LA CLÁUSULA SÉPTIMA DEL PRESENTE CONVENIO, DEBERÁ PAGAR A BH TRADE MARKET POR CONCEPTO DE PENA CONVENCIONAL LA CANTIDAD DE $5,000,000.00 (CINCO MILLONES DE PESOS 00/100 MONEDA NACIONAL) (LA “PENA CONVENCIONAL”). LA PENA CONVENCIONAL DEBERÁ SER PAGADA DENTRO DE LOS 2 (DOS) DÍAS HÁBILES CONTADOS A PARTIR DE QUE SE ACTUALICE EL INCUMPLIMIENTO CONFORME AL PRESENTE CONVENIO, EN EL DOMICILIO DE BH TRADE MARKET QUE SE SEÑALA EN ESTE CONVENIO O EN LA CUENTA BANCARIA QUE SEÑALE PARA TALES EFECTOS BH TRADE MARKET.</p>";
        $htmlsection->addHtml($section, $section2);

        $section2 = "<p>EN CASO DE INCUMPLIMIENTO, <b>EL EMPLEADO</b> FACULTA A BH TRADE MARKET A COMPENSAR CUALESQUIER MONTOS QUE EXISTAN O PUDIEREN EXISTIR EN UN FUTURO A FAVOR DE <b>EL EMPLEADO</b>, INCLUYENDO, COMISIONES, SUELDOS FUTUROS Y/O REPARTOS DE UTILIDADES, LAS CANTIDADES NECESARIAS PARA CUBRIR EL IMPORTE DE LA PENA CONVENCIONAL DE ACUERDO CON LO PREVISTO EN ESTA CLÁUSULA.</p>";
        $htmlsection->addHtml($section, $section2);

        $section2 = "<p><b>DÉCIMA.-  VIGENCIA.</b> EL PRESENTE CONVENIO SURTIRÁ SUS EFECTOS A PARTIR DEL DÍA DE SU FIRMA Y HASTA 5 (CINCO) AÑOS, ES DECIR, (60 MESES) A PARTIR DE QUE SE TERMINE CUALQUIER RELACIÓN COMERCIAL Y/O CONTRACTUAL O DE CUALQUIER OTRA ÍNDOLE QUE EXISTA ACTUALMENTE O EN EL FUTURO ENTRE <b>EL EMPLEADO</b> Y BH TRADE MARKET Y/O CUALQUIERA DE SUS SUBSIDIARIAS, ACCIONISTAS Y/O PROPIETARIOS (EN LO SUCESIVO LA “<b><u>VIGENCIA</u></b>”).</p>";
        $htmlsection->addHtml($section, $section2);
        ...
        $section2 = "<p><b>BH TRADE MARKET</b>: SAN ANDRES ATOTO 155 PISO 1 LOCAL A, UNIDAD SAN ESTEBAN, NAUCALPAN DE JUÁREZ. ESTADO DE MÉXICO.53550</p>";
        $htmlsection->addHtml($section, $section2);
        ...
        $table->addCell(5000, $cellRowSpan)->addText('BH TRADEMARKET',$bodyBoldStyle, $center);
        ...
        $table->addRow();
        $table->addCell(5000, $cellRowSpan)->addText($name. ' '. $lastname,$bodyBoldStyle, $center);
        $table->addCell(5000, $cellRowSpan)->addText($company. '<w:br/>'.'REPRESENTADA POR:'. '<w:br/>'.'DAVID LEVY HANO' ,$bodyBoldStyle, $center);
