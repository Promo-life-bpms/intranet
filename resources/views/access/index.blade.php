    ...
    <div class="card-body m-2">
            ...
            <div class="row">
                <div class="container d-flex justify-content-around">
                    <div class="card text-dark " style="border: 1px solid #032A3D;  width:240px; height:220px;">
                    ...
                    <div class="card text-dark " style="border: 1px solid #032A3D;  width:240px; height:220px;">                        <img src="https://res.cloudinary.com/dte7upwcr/image/upload/blog/blog2/como-hacer-una-encuesta-en-google-forms/como-hacer-una-encuesta-en-google-forms-img_header.jpg"
                            style="width: 100%; height:120px;  object-fit: contain;" class="card-img-top" alt="imagen">
                        <div class="card-body" style="padding-top:0; padding-bottom:0">
                    ...
                    <div class="card text-dark " style="border: 1px solid #032A3D;  width:240px; height:220px;">                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQXqlbOw2PNu8YEGN7uixN9ucllojqJ4fQK9g&usqp=CAU"
                            style="width: 100%; height:120px;  object-fit: contain;" class="card-img-top" alt="imagen">
                        <div class="card-body" style="padding-top:0; padding-bottom:0">
            ...
            <div class="row">
                ...
                <div class="container d-flex justify-content-around">
                    ...
                    @foreach ($access as $acc)
                        <div class="card m-1 "style="border: 1px solid #032A3D;"  >
