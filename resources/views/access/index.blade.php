        ...
        @foreach($access as $acc)
            <li class="access_item">
                <div class="card" style="width: 200px; height:200px;">
                    <img src="{{$acc -> access_img}}" style="width: 100%; height:100px;  object-fit: cover;" class="card-img-top" alt="imagen">
                    <div class="card-body">
                        <h5 class="card-title">{{$acc -> access_title}}</h5>
                        <br>
                        <a href="{{$acc -> access_url}}" style="width: 100%" class="btn btn-primary with">ABRIR</a>
                    </div>  
                </div>
            </li>
        @endforeach
