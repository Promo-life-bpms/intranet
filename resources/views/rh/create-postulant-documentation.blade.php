...
<div class="card-body">
    ...
    <div class="row">
        ...
        <div class="col-md-5 cont2">
            ...
            <input type="radio" name="company" value="promolife" @if($postulant->company_id == 1)checked @endif>
            <label for="promolife">Promo life S de RL de CV</label><br>
            <input type="radio" name="company" value="bhtrademarket" @if($postulant->company_id == 2)checked @endif>
            <label for="bhtrademarket">BH Tade Market SA de CV</label><br>
            <input type="radio" name="company" value="promozale"  @if($postulant->company_id == 3)checked @endif>
            <label for="promozale">Promo Zale SA de CV</label><br>
            <input type="radio" name="company" value="trademarket57" @if($postulant->company_id == 4)checked @endif>
            <label for="trademarket57">Trade Market 57 SA de CV</label><br>
            <input type="radio" name="company" value="unipromtex" @if($postulant->company_id == 5)checked @endif>
