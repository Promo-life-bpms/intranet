    ...
    <div class="card-body">
        ...
        <div class="row form-group">
            ...
            <div class="col-sm ">
                ...
                {!! Form::number('bank_name', null, ['class' => 'form-control', 'placeholder' => 'Ingrese el numero del banco']) !!}
            </div>  
        </div>
        ...
        <div class="row form-group">
            <div class="col-sm ">
                ...
                {!! Form::number('civil_status', null, ['class' => 'form-control', 'placeholder' => 'Ingrese la estado civil']) !!}
            </div>
        ...
        <div class="row form-group">
            <div class="col-sm ">
                ...
                {!! Form::number('address', null, ['class' => 'form-control', 'placeholder' => 'Ingrese la direccion']) !!}
            </div>
        ...
        <div class="row form-group">
            <div class="col-sm ">
                ...
                {!! Form::number('street', null, ['class' => 'form-control', 'placeholder' => 'Ingrese la calle']) !!}
            </div>
        ...
        <div class="row form-group">
            <div class="col-sm ">
                ...
                {!! Form::number('colony', null, ['class' => 'form-control', 'placeholder' => 'Ingrese la colonia']) !!}
            </div>
        ...
        <div class="row form-group">
            <div class="col-sm ">
                ...
                {!! Form::number('delegation', null, ['class' => 'form-control', 'placeholder' => 'Ingrese la delegacion o municipio']) !!}
            </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-sm ">
                ...
                {!! Form::date('date_admission', \Carbon\Carbon::now(), ['class' => 'form-control', 'placeholder' => 'Ingrese fecha de ingreso']) !!}
            </div>
