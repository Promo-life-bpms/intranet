        ...
        <div style="width: 100%;">
            <div class="card-seccion" style="height: 100vh;">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex">
                        <select style="width: max-content" class="form-select mr-1"
                        ...
                        <input placeholder="Fecha" type="date" class="form-control" style="width: 10rem" />
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align: center;">9-17/enero/2024</td>
                                <td style="text-align: center;">Tiempo completo</td>
                                <td style="text-align: center;"> <span class="badge bg-success">Aprobada</span>
                                </td>
                                <td style="text-align: center;"> <span class="badge bg-warning text-dark">En
                                        espera</span>
                                </td>
                                <td id="openModalVer" style="text-align: center; cursor: pointer;">Ver</td>
                            </tr>
                            <tr>
                                <th scope="row">2</th>
                                <td style="text-align: center;">Permisos especiales</td>
                                <td style="text-align: center;">19/agosto/2024</td>
                                <td style="text-align: center;">Tiempo completo</td>
                            ...
                            <tr>
                                <th scope="row">1</th>
                                <td style="text-align: center;">Ausencia</td>
                                <td style="text-align: center;">19/agosto/2024</td>
