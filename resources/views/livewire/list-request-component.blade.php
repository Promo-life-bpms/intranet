                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            @if ($request->doc_permiso)
                                                <tr>
                                                    <th style="vertical-align: middle; display: flex; flex-direction: column; ">
                                                        Justificante
                                                        <button class="btn-block btn btn-sm btn-warning mb-2" wire:click="cambiarEditarJustificante">
